  ...
  return (
    <div {...props}>
      <svg className="icon" viewBox="0 -16 384 544">
        ...
        <use xlinkHref="#glassWater" stroke="currentColor" strokeWidth="32px" />
        <use xlinkHref="#glassWater" stroke="black" strokeWidth="32px" strokeOpacity="0.5" strokeLinejoin="round" />
      </svg>
    </div>
  );
}
